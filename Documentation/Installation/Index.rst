...
On non composer based TYPO3 installations you can install `checkmysite` still
...
4.  Install `checkmysite`
    ...
    Use the search field to find `checkmysite`. Choose the `checkmysite` line from
    the search result and click on the cloud icon to install `checkmysite`.

Next step
=========

:ref:`Configure checkmysite <configuration>`.
